...
public class WeatherActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        swipeRefresh.setColorSchemeColors(R.color.colorWhite);
        ...
        if (weatherString != null) {
         ...
         //   String weatherId = getIntent().getStringExtra("weather_id");
          ...
          //  Log.d(TAG, "onCreate: 2222222222222222222");
    ...
    public void requestWeather(final String weatherId) {
        String weatherUrl="http://guolin.tech/api/weather?cityid="+
                weatherId+"&key=833e223117f6466885fbba31e0fcdfc6 ";
    ...
    private void showWeatherInfo(Weather weather) {
        // Log.d("aaaaaa", weather.basic.updata.updateTime.split(" ")[1]);
        String cityName = weather.basic.cityName;
       // Log.d(TAG, "showWeatherInfo: *****************" + weather.basic.update);
